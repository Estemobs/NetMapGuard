"""Tests for netmapguard.enrich module."""

import pytest
from unittest.mock import patch, MagicMock

from netmapguard.enrich import geolocate, get_my_location, clear_cache
...
class TestGeolocate:
    ...
    def test_success(self):
        with patch("netmapguard.enrich._SESSION") as mock_sess:
